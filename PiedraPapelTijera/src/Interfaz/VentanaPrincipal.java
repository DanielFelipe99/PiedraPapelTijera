...
//Implementamos librerias para el encriptado, el Dao y el RMI
    ...
    private void btnJugarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJugarActionPerformed
        ...
        nombre = txtPantalla.getText();
         if(cLogin.VerificarUsuarios(nombre)){
            JOptionPane.showMessageDialog(this, "Usuario correcto, presiona ok para continuar...", "¡Genial!", JOptionPane.INFORMATION_MESSAGE);
